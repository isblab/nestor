...
xlr_dss = IMP.pmi.restraints.crosslinking.CrossLinkingMassSpectrometryRestraint(root_hier=root_hier,database=xldb_dss,length=28.0,label="XLDSS",filelabel='dss',resolution=1,slope=0.03,linker=ihm.cross_linkers.dss,nest=True)
...
xlr_edc_evi = IMP.pmi.restraints.crosslinking.CrossLinkingMassSpectrometryRestraint(root_hier=root_hier,database=xldb_edc,length=18.0,label="XLEDC",filelabel='edc',resolution=1,slope=0.03,linker=ihm.cross_linkers.edc,nest=True)
...
xlr_dss_evi = IMP.pmi.restraints.crosslinking.CrossLinkingMassSpectrometryRestraint(root_hier=root_hier,database=xldb_dss,length=28.0,label="XLDSS",filelabel='dss',resolution=1,slope=0.03,linker=ihm.cross_linkers.dss,nest=True)
...
mc1.execute_macro()
ns = IMP.pmi.macros.NestedSampling(num_init_frames=nframes,
                                   num_frames_per_iter = 10,
                                   nester_niter=5000,
                                   rex_macro=mc1,
                                   nester_restraints=nester_restraints)
