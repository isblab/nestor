...
xl1db.create_set_from_file(f"{datadirectory}/sampling_polii_xlinks_w_header.csv")
...
ns = IMP.pmi.macros.NestedSampling(rex_macro=mc1,
                                   nester_restraints=nester_restraints,
                                   h_param_file=h_param_file)

ns_return = ns.execute_nested_sampling2()
sys.exit(ns_return)
