...
class CrossLinkingMassSpectrometryRestraint(IMP.pmi.restraints.RestraintBase):
    ...
    def __init__(
        ...
        super(CrossLinkingMassSpectrometryRestraint, self).__init__(
            model, weight=weight, label=label, restraint_set_class=_DataRestraintSet
        )
    ...
    # def get_output_to_nest_check(self):
    #     """Get the output of the restraint to be used by the IMP.pmi.output
    #        object"""
...
class CysteineCrossLinkRestraint(object):
    ...
    def get_output(self):
        ...
        for eps in self.epsilons.keys():
            output[
                "CysteineCrossLinkRestraint_epsilon_" + eps + "_" + self.label
...
class DisulfideCrossLinkRestraint(object):
    ...
    def get_output(self):
        ...
        output[
            "DisulfideBondRestraint_Linear_Score_" + self.label
