...
class NestedSampling():
    def __init__(self,num_init_frames,num_frames_per_iter,nester_niter,nester_restraints,rex_macro,max_plateau_hits,max_failed_iter):
        ...
        self.max_plateau_hits = max_plateau_hits
        self.plateau_hits = 0
        self.max_failed_iter = max_failed_iter
        self.failed_iter = 0
